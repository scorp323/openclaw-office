...
export function ProviderCard({ providerId, config, onEdit, onDelete }: ProviderCardProps) {
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-600 dark:bg-gray-700/50">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <div className="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
            ...
            {models.length > 0 && <span>{t("settings.providers.models", { count: models.length })}</span>}
          </div>
        </div>
      </div>
