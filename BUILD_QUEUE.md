...
13. **agent-chat-shortcut** — QUEUED (Build failed: TypeScript errors - QuickActionsFab.tsx, SystemHealthBar.tsx): From the office floor plan, tap agent → "Chat" button → opens /chat pre-addressed to that agent.
